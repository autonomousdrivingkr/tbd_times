...
const FAQS: { q: string; a: React.ReactNode; text: string }[] = [
  {
    ...
    text: "TBD Times는 전 세계의 인공지능(AI), 투자·금융, 가상자산(코인) 분야 뉴스를 매일 아침 자동으로 모아 한 페이지에서 빠르게 훑어볼 수 있도록 정리하는 한국어 데일리 뉴스 브리핑입니다. 신뢰할 수 있는 국내외 수십 개 매체가 공개한 RSS 피드에서 헤드라인과 짧은 요약을 수집해 분야별·키워드별로 분류해 보여줍니다.",
  },
  {
    ...
    text: "아니요. TBD Times는 각 기사의 제목과 짧은 요약, 그리고 원문 링크만 제공합니다. 전체 본문을 읽으려면 기사 카드를 클릭해 해당 매체의 원문 페이지로 이동하시면 됩니다. 저작권은 모두 원 매체에 있으며, 본 서비스는 독자가 읽을 만한 원문을 더 쉽게 찾도록 돕는 길잡이 역할을 합니다.",
  },
  {
    q: "뉴스는 얼마나 자주 갱신되나요?",
    a: (
  ...
  },
  {
    ...
    text: "아니요. TBD Times의 모든 콘텐츠는 정보 제공만을 목적으로 하며, 어떠한 투자 권유나 자문도 아닙니다. 투자 판단과 그 결과에 대한 책임은 이용자 본인에게 있습니다.",
  },
  {
    q: "광고는 왜 표시되나요?",
    a: (
